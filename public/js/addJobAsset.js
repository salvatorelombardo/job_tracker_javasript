...
addJobAsset.util = function () {
    if (document.getElementById('validateinfoBtn')) {
        document.getElementById('validateinfoBtn').addEventListener('click', addJobAsset.processForm, false);
    }
}

addJobAsset.processForm = function () {
    var obj = {},
        i = 0;
    ...
    Ajax.sendRequest('/accountTestForm', function (res) {
        ...
        if (obj.masterstatus === 'success') {
            ...
            addJobAsset.formValidation(obj.elements);
        }
...
addJobAsset.formValidation = function (obj) {
    var i = 0,
        labels;

    /* CLEAR ALL FORM ERRORS FROM A POSSIBLE PREVIOUS FAILED SUBMISSION */
    addJobAsset.clearFormErrors();
...
addJobAsset.clearFormErrors = function () {
    var labels, i = 0;
